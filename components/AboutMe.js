          ...
          <Row className="place-content-center">
            <Col xs={12} lg={9}>
              <p className=" my-6 text-lg lg:text-xl xl:text-2xl text-darkbrown font-roboto text-left">
                Hi, I'm Sarah Ramirez! I graduated with my Bachelors in Science
                in Computer Science with Business Applications at the University
                of California, Riverside. I am currently a Graduate student in
                Computer Science at the University of California, Riverside.
                Alongside my academic pursuits, I enjoy trying new foods,
                exploring new coffee shops, and reading new books. I enjoy
                solving complex problems and creating innovative solutions that
                can make a positive impact in the world. Through my education
                and hands-on experience, I have developed a solid foundation in
                various programming languages, algorithms, and data structures.
                I can't wait to see what opportunities come my way as continue
              ...
              <div className="mt-8 mr-6">
                ...
                <ul>
                  ...
                  <li className=" font-roboto leading-tight ">
                    Advanced Computer Architecture &#x2022; Advanced Operating
                    Systems &#x2022; Data Structures and Algorithms (including
                    Design and Analysis of Algorithms) &#x2022; Discrete
                    Structures &#x2022; Software Construction &#x2022; Computer
                  ...
                  <li className="font-roboto leading-tight">
                    ...
                    &#x2022; Data Analysis Methods &#x2022; Natural Language
                    Processing
                  </li>
                  <li className="text-lg font-bold leading-tight font-roboto text-left">
                  ...
                  <li className="font-roboto leading-tight">
                    Decision Analysis and Management Science &#x2022; Production
            ...
            <Col md={12} lg={4}>
              ...
              <div className="mt-6">
                ...
                <p className="font-roboto text-left">
                  C++, Javascript, Python, HTML/CSS, SQL, Pandas, NumPy,
                  Scikit-Learn
                </p>
              </div>
              <div className="mt-6">
